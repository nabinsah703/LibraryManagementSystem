...
namespace LMS_LibraryTraining.UserScreen
{
    public partial class UserHome : System.Web.UI.Page
    {
        ...
        {
            cmd = new SqlCommand("select sum(fineamount)as tot from BookFineRecord where member_id=@mid", conn.GetConnection());
        ...
        {
            cmd = new SqlCommand("select count(*)as Totalbook from book_master_tbl", conn.GetConnection());
            cmd.CommandType = System.Data.CommandType.Text;
            cmd.Parameters.Clear();
            DataTable dt2 = new DataTable();
            dt2 = conn.Load_Data(cmd);
        ...
        {
            cmd = new SqlCommand("select count(*)as Issubook from book_issue_tbl where member_id=@mid", conn.GetConnection());
            cmd.CommandType = System.Data.CommandType.Text;
            cmd.Parameters.Clear();
            cmd.Parameters.AddWithValue("@mid", Session["mid"].ToString());
            DataTable dt2 = new DataTable();
