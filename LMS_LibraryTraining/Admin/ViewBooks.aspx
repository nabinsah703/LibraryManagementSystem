<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="ViewBooks.aspx.cs" Inherits="LMS_LibraryTraining.Admin.ViewBooks" %>
                            ...
                            <ItemTemplate>
                                <div class="container-fluid">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-2">
                                            <asp:Image class="img-fluid" ID="Image1" runat="server" ImageUrl='<%# Eval("book_img_lin") %>' />
                                        </div>
                                    </div>
                                </div>
                            </ItemTemplate>
