...
namespace LMS_LibraryTraining.Admin
{
    public partial class AdminHome : System.Web.UI.Page
    {
        ...
        {
            cmd = new SqlCommand("select sum(fineamount)as tot from BookFineRecord", conn.GetConnection());
        ...
        {
            cmd = new SqlCommand("select count(*)as Issubook from book_issue_tbl", conn.GetConnection());
            cmd.CommandType = System.Data.CommandType.Text;
            cmd.Parameters.Clear();
